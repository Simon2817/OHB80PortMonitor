...
QT_MOC_LITERAL(1, 16, 22), // "communicationCompleted"
...
QT_MOC_LITERAL(7, 79, 23), // "onCommunicationRecorded"
QT_MOC_LITERAL(8, 103, 18), // "onCommandCompleted"
QT_MOC_LITERAL(9, 122, 5), // "start"
QT_MOC_LITERAL(10, 128, 4) // "stop"

    },
    "MonitorDataTask\0communicationCompleted\0"
    "\0ModbusCommand\0cmd\0masterId\0description\0"
    "onCommunicationRecorded\0onCommandCompleted\0"
    "start\0stop"
};
...
void MonitorDataTask::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->communicationCompleted((*reinterpret_cast< ModbusCommand(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3]))); break;
        case 1: _t->onCommunicationRecorded((*reinterpret_cast< ModbusCommand(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 2: _t->onCommandCompleted((*reinterpret_cast< ModbusCommand(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        ...
        {
            using _t = void (MonitorDataTask::*)(ModbusCommand , QString , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MonitorDataTask::communicationCompleted)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MonitorDataTask::communicationCompleted(ModbusCommand _t1, QString _t2, QString _t3)
{
