...
QT_MOC_LITERAL(7, 85, 13), // "statusChanged"
QT_MOC_LITERAL(8, 99, 33), // "ModbusConnecter::ConnectionSt..."
QT_MOC_LITERAL(9, 133, 6), // "status"
...
void NetworkStatusTask::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (NetworkStatusTask::*)(ModbusConnecter::ConnectionStatus , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NetworkStatusTask::statusChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void NetworkStatusTask::statusChanged(ModbusConnecter::ConnectionStatus _t1, const QString & _t2)
{
