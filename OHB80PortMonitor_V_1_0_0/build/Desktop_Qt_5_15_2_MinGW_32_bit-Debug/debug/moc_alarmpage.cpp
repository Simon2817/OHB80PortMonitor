...
QT_MOC_LITERAL(1, 10, 22), // "onNetworkStatusChanged"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 33), // "ModbusConnecter::ConnectionSt..."
QT_MOC_LITERAL(4, 68, 6), // "status"
QT_MOC_LITERAL(5, 75, 8) // "masterId"

    },
    "AlarmPage\0onNetworkStatusChanged\0\0"
...
void AlarmPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AlarmPage *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onNetworkStatusChanged((*reinterpret_cast< ModbusConnecter::ConnectionStatus(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        default: ;
        }
    }
}
