#ifndef MTM_FIRMWARE_UPGRADER_H
#define MTM_FIRMWARE_UPGRADER_H
...
class MtmFirmwareUpgrader : public QObject
{
    Q_OBJECT
...
public:
    ...
    explicit MtmFirmwareUpgrader(ModbusTcpMaster *master, QObject *parent = nullptr);
    ~MtmFirmwareUpgrader();
